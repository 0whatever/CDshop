...
class controlThread extends Thread{
	...
	public void run() {
		new getinThread(cd1).start();
		new saleThread(cd1).start();
		new saleThread(cd1).start();
		new saleThread(cd1).start();
		new rentThread(cd2).start();
		new rentThread(cd2).start();
		new rentThread(cd2).start();
		try {
